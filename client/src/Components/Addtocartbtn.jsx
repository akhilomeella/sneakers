...
const Addtocart = ({ productId, size = "default" }) => {
  ...
  `}
    ...
    `}
        >
          <button onClick={subtract} className="cursor-pointer">
            <img src={minus} alt="Decrease" className="w-3 h-1" />
          </button>
          <h1>{value}</h1>
          <button onClick={addition} className="cursor-pointer">
        ...
        <button
          ...
          className="
      flex justify-center items-center bg-[#f67d1c] text-white gap-x-2 rounded-lg px-2 py-2 text-sm lg:px-4 lg:py-2 lg:text-sm  max-sm:text-base w-1/3 cursor-pointer"
        >
          <svg
